  ...
  class SlideShare < Liquid::Tag
    ...
    def render(context)
     # %(<iframe src="http://www.slideshare.net/slideshow/embed_code/#{@id}" width="595" height="446" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC;border-width:1px 1px 0;margin-bottom:5px" allowfullscreen></iframe> )
      #%(<div class="embed-ss-container"><iframe src="http://www.slideshare.net/slideshow/embed_code/#{@id}" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe></div>)
      %(<div class="embed-ss-container"><iframe src="http://www.slideshare.net/slideshow/embed_code/#{@id}"></iframe></div>)
    end
  end
end
